...
public final class Kepler452Fluids {
	...
	public static final Fluid EXAMPLE_FLUID = new Fluid("example_fluid",
			new ResourceLocation(Main.MODID, "blocks/example_fluid_still"),
			new ResourceLocation(Main.MODID, "blocks/example_fluid_flow"));
	...
	public static void init() {
		...
		EXAMPLE_FLUID.setUnlocalizedName(Main.MODID + "." + "example_fluid");
