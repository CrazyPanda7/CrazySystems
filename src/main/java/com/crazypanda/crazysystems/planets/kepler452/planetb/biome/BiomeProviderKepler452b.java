...
import com.crazypanda.crazysystems.planets.kepler452.planetb.biome.gen.GenLayerKepler452b;
...
public class BiomeProviderKepler452b extends BiomeProvider {
	...
	public BiomeProviderKepler452b(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerKepler452b.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderKepler452b(World world) {
