...
public class SkyProviderKepler452b extends IRenderHandler {
	
	private static final ResourceLocation sunTexture = new ResourceLocation(CrazySystems.MODID, "textures/celestialbodies/kepler452b.png");
	...
	public SkyProviderKepler452b(IGalacticraftWorldProvider mercuryProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderKepler452b.sunTexture);
